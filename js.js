...
Мой 
/*piano.addEventListener('mousedown','playNote', (event) => {
...
const stopSound = (event) => {
  event.target.classList.remove('piano-key-active', 'piano-key-activ',
  'piano-key-active-pseudo');
}
...
const stopCorrespondOver = () => {
  pianoКeys.forEach((elem) => {
    elem.classList.remove('piano-key-active', 'piano-key-activ',
    'piano-key-active-pseudo');
